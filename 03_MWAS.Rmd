...
PAH_MWAS_export<- PAH_MWAS_result |>
  filter(beta_dir == "positive-significant" | beta_dir == "negative-significant")

write_csv(PAH_MWAS_export, "~/Documents/MWAS_home/pj_results/pah_baby/c18neg/c18neg_mom.csv")
```
...
ggsave("~/Documents/MWAS_home/pj_results/pah_baby/c18neg/c18neg_mom.tiff",
