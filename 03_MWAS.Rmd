...
write_csv(PAH_MWAS_result, "~/Documents/MWAS_home/pj_results/pah_baby/hilic_pos/mwas_pah_hilic_pos_baby.csv")
```
...
ggsave("~/Documents/MWAS_home/pj_results/pah_baby/hilic_pos/manh_plt_PAH_baby.tiff",
...
write.table(PAH_MWAS_result_mummi, "~/Documents/MWAS_home/pj_results/pah_baby/hilic_pos/PAH_MWAS_result_mummi.txt", sep="\t", row.names=F)
```
